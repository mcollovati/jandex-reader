...
@TopCommand
@Command(name = "jandex-reader",
        mixinStandardHelpOptions = true,
        versionProvider = JandexReaderCommand.VersionProvider.class,
        description = "Inspects Jandex indexes (META-INF/jandex.idx) in JAR files, directories, .idx files and Maven artifacts.",
        footer = {"",
                "Sources can be:",
...
public class JandexReaderCommand {
    ...
    public static class VersionProvider implements IVersionProvider {
        ...
        public String[] getVersion() {
            ...
            String version = config.getOptionalValue("quarkus.application.version", String.class).orElse("unknown");
